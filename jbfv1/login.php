                ...
                try {
                    ...
                    if ($user) {
                        if (password_verify($data['password'], $user['password'])) {
                            ...
                            logSecurityEvent('Successful Login', 'User ID: ' . $user['id']);
                            ...
                            logSecurityEvent('Failed Login Attempt', 'Email: ' . $data['email']);
                        }
                    } else {
                        $error_message = 'Invalid email or password.';
                        logSecurityEvent('Failed Login Attempt', 'Email: ' . $data['email']);
                    ...
                    logSecurityEvent('Database Error', 'Login: ' . $e->getMessage());
                }
            } else {
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>Login - <?php echo htmlspecialchars($settings['church_name'] ?? 'Joy Bible Fellowship'); ?></title>
...
<body>
        ...
        <div class="header-container">
            <div class="logo">
                ...
                <div class="logo-text">
                    ...
                    <p><?php echo htmlspecialchars($settings['church_tagline'] ?? 'Love God. Love People. Serve the World.'); ?></p>
                </div>
            </div>
            <nav>
                <ul>
    ...
    <section class="auth-container">
        <div class="auth-card animate-fadeIn">
            <h2>Welcome Back</h2>
                            <p>Sign in to your <?php echo htmlspecialchars($settings['church_name'] ?? 'Joy Bible Fellowship'); ?> account to access member resources and more.</p>
            ...
            <form method="POST" action="" id="loginForm">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="login-email" name="email" value="<?php echo htmlspecialchars($_POST['email'] ?? ''); ?>" required>
                ...
                <button type="submit" name="login_submit" class="btn" id="loginBtn">Sign In</button>
            </form>
            
            <div class="auth-links">
                <a href="forgot-password.php">Forgot password?</a> • <a href="register.php">Create an account</a>
            </div>
    ...
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            requiredFields.forEach(field => {
                const input = document.getElementById(field === 'email' ? 'login-email' : 'login-password');
                const formGroup = input.closest('.form-group');
                const errorField = document.getElementById(field + '_error');
                
                if (!input.value.trim()) {
                    formGroup.classList.add('error');
                    if (errorField) errorField.textContent = `${input.previousElementSibling.textContent} is required`;
                    isValid = false;
                } else {
            ...
            if (isValid) {
                ...
                try {
                    if (typeof showToast === 'function') {
                        showToast('Form validation passed! Signing in...', 'success', 2000);
                    }
                } catch (error) {
                    // Toast error ignored
                }
        ...
        socialButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                // Social login would redirect to authentication in a real application
            });
        });
